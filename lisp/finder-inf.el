...
(setq finder-package-info '(
    ...
    ("=cmutex.el"
        ...
        nil)
    ("=co-isearch.el"
        "incremental command search for comint"
        nil)
    ("=collisions.el"
        nil
        nil)
    ...
    ("=old-etags.el"
        ...
        nil)
    ("=old-inf-lisp.el"
        "run an external lisp interpreter in an Emacs window"
        nil)
    ("=old-screen.el"
        "multi-screen management independent of window systems."
        nil)
    ("=old-shell.el"
