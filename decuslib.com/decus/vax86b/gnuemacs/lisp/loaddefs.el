;;;	$Source: /u1/third_party/gnuemacs.v17/lisp/RCS/loaddefs.el,v $
;;;	$Author: rlk $
;;;	$Locker:  $
;;;	$Header: loaddefs.el,v 1.10 86/02/04 11:53:56 rlk Exp $
...
(defconst abbrev-file-name "EMACSVAR_ABBREVS"
...
The user's emacsini file is altered so that this will apply
...
;************************************************************************
;*                                                                      *
;*  WARNING:  rmail is not an Athena-supported part of GNUEMACS.        *
;*  Consulting help is not available, and future versions may not be    *
;*  compatible with this one.   Use this function at your own risk.     *
;*                                                                      *
;************************************************************************
;
;Read and edit incoming mail, in the style of ITS/TOPS-20 Babyl.
...
;************************************************************************
;
;Like mail command but displays in other window.  Not the official Athena
;mail system, this is a part of Rmail."
;  t)
