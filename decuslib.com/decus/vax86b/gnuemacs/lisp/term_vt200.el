...
;;
;; February 1986, Mukesh Prasad
;; Modified bindings for VMS
;;   DO:        "subprocess-command"	(old "eval-expression")
;;   F12(BS):	"beginning-of-line"
;; Modified FIND to remember its last argument and to use
;; regular search instead of regular expression search.
;;
...
(if (not CSI-map)
    (progn
     ...
     (define-key CSI-map "1~" 'search-forward-remember)    ;; Find
