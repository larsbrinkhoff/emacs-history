...
#ifdef VMS
Lisp_Object Vmb_completion_predicate, Qmb_completion_predicate;
#else
...
#ifdef VMS
  specbind (Qmb_completion_predicate, pred);
#else
...
#ifdef VMS
			     ? Vmb_local_completion_map
			     : Vmb_local_must_match_map,
#else
...
#ifdef VMS
    internal_output_to_temp_buffer (" *Completions*",
#else
...
#ifdef VMS
  Qmb_completion_predicate = intern ("minibuffer-completion-predicate");
  staticpro (&Qmb_completion_predicate);
#else
...
#ifdef VMS
  DefLispVar ("minibuffer-completion-predicate", &Vmb_completion_predicate,
    "Holds PREDICATE argument to completing-read.");
  Vmb_completion_predicate = Qnil;
#else
...
#ifdef VMS
  ndefkey (Vmb_local_completion_map, Ctl ('g'), "abort-recursive-edit");
  ndefkey (Vmb_local_completion_map, Ctl ('m'), "exit-minibuffer");
  ndefkey (Vmb_local_completion_map, Ctl ('j'), "exit-minibuffer");
  ndefkey (Vmb_local_completion_map, '\t', "minibuffer-complete");
  ndefkey (Vmb_local_completion_map, ' ', "minibuffer-complete-word");
  ndefkey (Vmb_local_completion_map, '?', "minibuffer-completion-help");

  ndefkey (Vmb_local_must_match_map, Ctl ('g'), "abort-recursive-edit");
  ndefkey (Vmb_local_must_match_map, Ctl ('m'), "minibuffer-complete-and-exit");
  ndefkey (Vmb_local_must_match_map, Ctl ('j'), "minibuffer-complete-and-exit");
  ndefkey (Vmb_local_must_match_map, '\t', "minibuffer-complete");
  ndefkey (Vmb_local_must_match_map, ' ', "minibuffer-complete-word");
  ndefkey (Vmb_local_must_match_map, '?', "minibuffer-completion-help");
#else
